...
<head>
  ...
  <title>BEST Corporate Gifts and Souvenirs Ordering System : Orders Details</title>
  <!-- Bootstrap -->
    ...
    try {
      ...
      $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
        $stmt = $conn->prepare("SELECT * FROM tbl_orders_a160195, tbl_staffs_a160195_pt2,
          tbl_customers_a160195_pt2 WHERE
...
<div class="container-fluid lightblue">
  ...
  <div class="row myform">
    <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
      ...
      <form action="orders_details.php" onsubmit="validateForm()" method="post" class="form-horizontal" name="frmorder" id="forder">
